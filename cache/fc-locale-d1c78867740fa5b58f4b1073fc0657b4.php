...
{$scriptName} {$pluginName} [xmlFileName] [journal_path] issue [issueId]',
  ...
  'plugins.importexport.crossref.errors.noDOIprefix' => 'In order to use this plug-in please go to the "Public Identifier" plug-in category, enable and configure the DOI plug-in and specify a valid DOI prefix there.',
); ?>